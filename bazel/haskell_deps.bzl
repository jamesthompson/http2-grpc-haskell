...
haskell_cabal_library(
  ...
  haddock = False,
    ...
    """,
        ...
        strip_prefix = "http2-2.0.5",
        urls = ["http://hackage.haskell.org/package/http2-2.0.5/http2-2.0.5.tar.gz"],
    )
...
haskell_cabal_binary(
  ...
  visibility = ["//visibility:public"],
    ...
    """,
        ...
        strip_prefix = "proto-lens-protoc-0.7.0.0",
        urls = ["http://hackage.haskell.org/package/proto-lens-protoc-0.7.0.0/proto-lens-protoc-0.7.0.0.tar.gz"],
    )
